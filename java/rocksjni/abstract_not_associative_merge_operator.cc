...
namespace rocksdb {
	...
	namespace JNIAbstractNotAssociativeMergeOperator {
		...
		class JNIMergeOperator : public MergeOperator {
			public:
				JNIMergeOperator(jboolean _allowSingleOperand, jboolean _allowShouldMerge, jboolean _allowPartialMultiMerge) {
...
jlong  Java_org_rocksdb_AbstractNotAssociativeMergeOperator_newOperator(
	...
	std::shared_ptr<rocksdb::MergeOperator> p =
		std::make_shared<rocksdb::JNIAbstractNotAssociativeMergeOperator::JNIMergeOperator>(allowSingleOperand, allowShouldMerge, allowPartialMultiMerge);
